...
export default function Header() {
    return (
        <header className="header">
            ...
            <a href={"https://github.com/oglenyaboss"} className="social--icon">
                <img width="50" height="50" src="https://img.icons8.com/ios-filled/50/github.png" alt="github"/>
            </a>
            <a href={"https://vk.com/sashatop01"} className={"social--icon"}>
                <img width="50" height="50" src="https://img.icons8.com/ios/50/vk-circled--v1.png" alt="vk-circled--v1"/>
            </a>
            <a href={"https://t.me/pidrilny_club"} className={"social--icon"}>
